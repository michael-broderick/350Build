...
static int bed_state;
static int usds_state;
static int system_state;
static int outPut; //0=nothing:1=low:2=high


static bool onOffSwitch;
static bool key;
static bool cancelBotton;


static void set_execute(void)
{
    set_bed_current();
    set_usds_current();
    set_system();
...
static int set_bed_current(void)
{
...
static int set_usds_current(void)
{
